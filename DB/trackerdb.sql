...
CREATE TABLE IF NOT EXISTS `event` (
  ...
  `attending` TINYINT NULL DEFAULT 0,
  `enabled` TINYINT NOT NULL DEFAULT 1,
  PRIMARY KEY (`id`),
...
START TRANSACTION;
USE `trackerdb`;
INSERT INTO `event` (`id`, `address_id`, `name`, `description`, `start_date`, `end_date`, `start_time`, `end_time`, `capacity`, `img_url`, `created_on`, `updated_on`, `attending`, `enabled`) VALUES (1, 1, 'test', 'test data', '2020-06-05', NULL, '17:00:00', NULL, NULL, NULL, '2020-06-05 17:00:00', NULL, 0, 0);
INSERT INTO `event` (`id`, `address_id`, `name`, `description`, `start_date`, `end_date`, `start_time`, `end_time`, `capacity`, `img_url`, `created_on`, `updated_on`, `attending`, `enabled`) VALUES (2, 2, 'Let It Roll Summer', 'The world\'s largest open air Drum & Bass festival, held in the Czech Republic.', '2021-08-05', '2020-08-07', '18:00:00', NULL, 25000, 'https://media.resources.festicket.com/www/admin/uploads/images/82954041_2995082460524091_7145943840938000384_o.png', '2020-06-05-17:00:00', NULL, 0, 1);
INSERT INTO `event` (`id`, `address_id`, `name`, `description`, `start_date`, `end_date`, `start_time`, `end_time`, `capacity`, `img_url`, `created_on`, `updated_on`, `attending`, `enabled`) VALUES (3, 3, 'Liquicity', 'An annual Dutch Drum & Bass festival hosted by Maduk.', '2021-07-16', '2021-07-18', '12:00:00', NULL, 15000, 'https://festival.liquicity.com/wp-content/uploads/2020/04/LF2021emblem.png', '2020-06-05-17:00:00', NULL, 0, 1);
INSERT INTO `event` (`id`, `address_id`, `name`, `description`, `start_date`, `end_date`, `start_time`, `end_time`, `capacity`, `img_url`, `created_on`, `updated_on`, `attending`, `enabled`) VALUES (4, 4, 'Rampage', 'A huge Drum & Bass and Dubstep festival held each year in the Belgian city of Antwerp.', '2021-09-18', '2021-09-19', '13:00:00', NULL, 30000, 'https://www.rampage.eu/2019/lay/140320/logo-rampage-new-date-100pxh.png', '2020-06-05-17:00:00', NULL, 0, 1);
INSERT INTO `event` (`id`, `address_id`, `name`, `description`, `start_date`, `end_date`, `start_time`, `end_time`, `capacity`, `img_url`, `created_on`, `updated_on`, `attending`, `enabled`) VALUES (5, 5, 'Innovation In The Dam', 'The original weekender Drum & Bass event in Amsterdam. Taking over Amsterdam\'s superclubs for 3 days of raving.', '2020-11-27', '2020-11-29', '18:00:00', NULL, 2000, 'https://innovationevents.co.uk/wp-content/uploads/2020/02/ITD20-SaveTheDateWeb.jpg', '2020-06-05-17:00:00', NULL, 0, 1);
INSERT INTO `event` (`id`, `address_id`, `name`, `description`, `start_date`, `end_date`, `start_time`, `end_time`, `capacity`, `img_url`, `created_on`, `updated_on`, `attending`, `enabled`) VALUES (6, 6, 'Let It Roll Winter', 'The smaller, indoor edition of the famous Let It Roll, held in the winter.', '2020-02-28', '2020-02-29', '19:00:00', NULL, 8000, 'https://letitroll.eu/wp-content/uploads/2019/10/WEBFLYER.jpg', '2020-06-06-17:00:00', NULL, 0, 1);
INSERT INTO `event` (`id`, `address_id`, `name`, `description`, `start_date`, `end_date`, `start_time`, `end_time`, `capacity`, `img_url`, `created_on`, `updated_on`, `attending`, `enabled`) VALUES (7, 7, 'Hospitality On The Beach', 'Following on from launching new festivals in London over the last couple of years, the legendary label and brand have since headed abroad. The destination: the famous resort and festival hotspot of The Garden, Tisno. And they\'re not doing it alone, taking the likes of Sun & Bass, Shogun Audio, EXIT Records and Gimme Five with them.', '2021-07-08', '2021-07-12', '12:00:00', NULL, 15000, 'https://static1.squarespace.com/static/5a16be382278e73e3d5685dd/t/5eaa875f46dc317f01375ae6/1588238923155/?format=1500w', '2020-06-06-17:00:00', NULL, 0, 1);
INSERT INTO `event` (`id`, `address_id`, `name`, `description`, `start_date`, `end_date`, `start_time`, `end_time`, `capacity`, `img_url`, `created_on`, `updated_on`, `attending`, `enabled`) VALUES (8, 8, 'Boomtown', 'Boomtown is a fictitious city set within an alternative world, populated with a plethora of curious characters roaming the streets and guiding the citizens through the labyrinth of adventures waiting to be discovered. Each chapter delves even further into the mythology of Boomtown, with endless stories for you to be part of and make your very own.', '2021-08-11', '2021-08-15', '09:00:00', NULL, 50000, 'https://www.boomtownfair.co.uk/img/splash/foreground-2020-v1.png', '2020-06-06-17:00:00', NULL, 0, 1);
INSERT INTO `event` (`id`, `address_id`, `name`, `description`, `start_date`, `end_date`, `start_time`, `end_time`, `capacity`, `img_url`, `created_on`, `updated_on`, `attending`, `enabled`) VALUES (9, 9, 'Hospitality In The Park', 'From the team behind legendary label Hospital Records and its event brand Hospitality, this festival is the UK\'s first outdoor event dedicated solely to drum and bass.', '2020-09-19', NULL, '10:00:00', NULL, 18000, 'https://media.resources.festicket.com/image/262x370/center/middle/filters:quality(70)/www/photos/4138-_poster.jpg', '2020-06-06-17:00:00', NULL, 0, 1);
INSERT INTO `event` (`id`, `address_id`, `name`, `description`, `start_date`, `end_date`, `start_time`, `end_time`, `capacity`, `img_url`, `created_on`, `updated_on`, `attending`, `enabled`) VALUES (10, 7, 'Outlook Origins', NULL, '2021-07-29', '2021-08-02', '18:00:00', NULL, 10000, 'https://static1.squarespace.com/static/5e26c9500380c52e91a7906e/t/5eab1fc6c4e3715560c375d1/1591279993393/?format=1500w', '2020-06-06-17:00:00', NULL, 0, 1);
